...
import applovin.hoangdv.libs.di.entry_point.AppLovinGlobalEntryPoint
...
fun Activity.invokeWithMaxInterstitial(
    ...
    if (this is AppCompatActivity) {
        val interLoader = appInject<AppLovinGlobalEntryPoint>().maxInterManager()
        interLoader.show(this) { showed ->
